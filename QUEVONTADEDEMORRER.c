...
int main(){
    ...
    int N1, D1, N2, D2, resultMain, N;
    char OP;
    printf("informe quantidade de testes: ");
    scanf("%d",&N);
    for(int i=0; i<N; i++)
    {
    	scanf("%d",&N1);
    ...
    {		
        ...
        {
            case '+':
               resultMain = soma(N1, D1, N2, D2);
                break;
            case '-':
               resultMain = subtracao(N1, D1, N2, D2);
                break;
            case '*':
              resultMain =  multiplicacao(N1, D1, N2, D2);
                break;
            case '/':
              resultMain =  divisao(N1, D1, N2, D2);
                break;
        }
        }
    }
